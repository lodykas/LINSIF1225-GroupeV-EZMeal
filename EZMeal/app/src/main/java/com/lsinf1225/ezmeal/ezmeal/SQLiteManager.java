...
public class SQLiteManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
       ...
       // s.execute();
        ...
        r.execute();
        r.bindString(1,"milshake aux fruits rouges");
        ...
        r.bindString(3,"dans une casserole chauffez le lait en surveillant la cuisson, lorsque le lait frémit doucement ajoutez y le choclat noir concassé, mélangez bien et rajoutez à la préparation la canelle, les clous de girofle ainsi qu'une c.à.c de muscade, sucrez à votre convenance. servez avec de la chantilly saupoudrée au cacao ");
        ...
        l.execute();
        l.bindString(1,"milkshake aux fruits rouges");
        l.bindString(2,"fruits rouges conglées");
        l.bindString(3,"150");
        l.execute();
        l.bindString(1,"milkshake aux fruits rouges");
        ...
        l.bindString(3,"100");
        l.execute();
        l.bindString(1,"chocolat chaud de noel");
        l.bindString(2,"cannelle");
        l.bindString(3,"1");
        l.execute();
        l.bindString(1,"chocolat chaud de noel");
        ...
        l.execute();
        l.bindString(1,"curry japonais");
        l.bindString(2,"curry japonaise");
        l.bindString(3,"1");
        l.execute();
        l.bindString(1,"donut new yorkais");
        l.bindString(2,"farine");
        l.bindString(3,"350");
        l.execute();
        l.bindString(1,"donut new yorkais");
        ...
        l.bindString(3,"100");
        l.execute();
        l.bindString(1,"gin tonic à la framboise");
        l.bindString(2,"gin");
        l.bindString(3,"10");
        l.execute();
        l.bindString(1,"gin tonic à la framboise");
        ...
        i.bindString(1,"donut new yorkais ");
        ...
        i.bindString(6,"4");
        i.execute();
        i.bindString(1,"milkshake aux fruits rouges");
        ...
        i.bindString(6,"1");
        i.execute();
        i.bindString(1,"gin tonic à la framboise");
